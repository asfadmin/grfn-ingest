...
def get_granule_data(inputs, config):
    ...
    data = {
        ...
        'bbox': list(reversed(granule_metadata['bbox'])),
        'additional_attributes': {
            ...
            'BYTES': file_size,
            'NEAR_START_LAT': granule_metadata['bbox'][0][0],
            'NEAR_START_LON': granule_metadata['bbox'][0][1],
            'FAR_START_LAT': granule_metadata['bbox'][1][0],
            'FAR_START_LON': granule_metadata['bbox'][1][1],
            'FAR_END_LAT': granule_metadata['bbox'][2][0],
            'FAR_END_LON': granule_metadata['bbox'][2][1],
            'NEAR_END_LAT': granule_metadata['bbox'][3][0],
            'NEAR_END_LON': granule_metadata['bbox'][3][1],
